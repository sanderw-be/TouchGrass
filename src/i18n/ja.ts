export default {
  ...
  // Home screen
  goal_reached: 'いい感じです！今日はもう外の空気をしっかり浴びました。',
  outside_time_awaits: '{{amount}} of outside time awaits today.',
  remaining_for_goal: '{{amount}} more to hit your daily goal.',
  this_week: 'This week',
  today: 'today',
  no_sessions_title: '今日はまだ外時間が記録されていません。',
  no_sessions_sub: 'ちょっと外の空気を吸いませんか？ここで追加できます！',
  todays_sessions: '今日の外時間',
  ...
  ring_timer_info: 'リングをタップすると、外時間タイマーを手動で始められます。',
  ...
  events_toggle_review: '要チェック',
  events_toggle_rejected: 'Rejected',
  events_none_recorded: 'まだ外時間は見つかっていません。',
  ...
  // Settings screen
  settings_section_detection: '自動記録',
  ...
  settings_hc_permission_missing: 'アクセスが必要です — タップして設定',
  ...
  settings_gps_desc: '位置情報で外時間を見つける',
  settings_gps_permission: 'Permission needed',
  settings_gps_permission_missing: 'アクセスが必要です — タップして設定',
  ...
  settings_notification_permission_missing: 'アクセスが必要です — タップして設定',
  ...
  settings_privacy_sublabel: 'あなたのデータはスマホの外に出ません',
  ...
  intro_welcome_body: 'スマホを置いて、もっと外へ出るための相棒です。',
  ...
  intro_hc_why_title: 'このアクセスが必要な理由',
  intro_hc_why_body:
  ...
  intro_location_why_title: 'このアクセスが必要な理由',
  ...
  intro_notifications_why_title: 'このアクセスが必要な理由',
  ...
  notif_title_4: '👟 くつを履いて出かけよう？',
  notif_title_5: '🌳 The outdoors is calling',

  // Notification bodies
  notif_body_none: '今日はまだ外に出ていませんか？短い散歩でも大丈夫！',
  ...
  notif_reason_urgent: '今日はまだ外に出られていません。',
