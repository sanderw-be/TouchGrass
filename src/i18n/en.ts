export default {
  ...
  intro_ready_tip_body: 'You can set up scheduled reminders in Settings → Reminders. Create weekly schedules for specific times and days to build a consistent outdoor routine.',
