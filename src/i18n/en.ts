export default {
  ...
  settings_location_active_badge: 'Active',
  ...
  settings_locations_pending_count: '{{count}} pending',
  settings_location_approve_title: 'Approve location',
  settings_location_approve_name_label: 'Name this location',
  settings_location_approve_confirm: 'Approve',
  ...
  location_edit_address_searching: 'Searching…',
