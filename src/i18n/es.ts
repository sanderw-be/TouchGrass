export default {
  ...
  // Home screen
  goal_reached: '¡Muy bien! Ya cumpliste tu ración de aire libre hoy.',
  outside_time_awaits: '{{amount}} of outside time awaits today.',
  remaining_for_goal: '{{amount}} more to hit your daily goal.',
  this_week: 'This week',
  today: 'today',
  no_sessions_title: 'Aún no has registrado tiempo al aire libre hoy.',
  no_sessions_sub: '¿Te apetece un poco de aire fresco? ¡Añádelo aquí!',
  todays_sessions: 'Momentos al aire libre de hoy',
  ...
  ring_timer_info: 'Toca el anillo para iniciar manualmente tu tiempo al aire libre.',
  ...
  // Session sources
  source_health_connect: 'Otras apps',
  source_gps: 'GPS',
  ...
  session_swipe_hint: 'Izquierda para fuera, derecha para dentro.',
  ...
  events_none_recorded: 'Todavía no hay momentos al aire libre.',
  ...
  // Settings screen
  settings_section_detection: 'Seguimiento automático',
  ...
  settings_hc_permission_missing: 'Acceso necesario — toca para configurarlo',
  ...
  settings_gps_desc: 'Reconocer momentos al aire libre con la ubicación',
  settings_gps_permission: 'Permission needed',
  settings_gps_permission_missing: 'Hace falta acceso — toca para configurarlo',
  ...
  location_edit_radius: 'Reconocimiento de ubicación',
  ...
  settings_reminders_sublabel: 'Avisos en el momento justo — aprende tu ritmo. Sin recopilar datos.',
  ...
  settings_notification_permission_missing: 'Hace falta acceso — toca para configurarlo',
  ...
  settings_privacy_sublabel: 'Tus datos nunca salen de tu teléfono',
  ...
  intro_welcome_body: 'Tu ayuda para dejar el móvil y salir más a menudo.',
  ...
  intro_hc_why_title: '¿Por qué este acceso?',
  intro_hc_why_body:
  ...
  intro_location_why_title: '¿Por qué este acceso?',
  ...
  intro_notifications_why_title: '¿Por qué este acceso?',
  ...
  intro_calendar_why_title: '¿Por qué este acceso?',
  ...
  intro_calendar_data_scope: 'Solo leemos horas — sin detalles ni personas. Todo se mantiene privado en tu dispositivo.',
  ...
  notif_title_4: '👟 ¿Zapas puestas y salimos?',
  notif_title_5: '🌳 The outdoors is calling',

  // Notification bodies
  notif_body_none: '¿Aún no has salido hoy? ¡Un paseo corto también cuenta!',
  ...
  notif_reason_urgent: 'hoy todavía no has conseguido salir.',
