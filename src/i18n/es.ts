export default {
  ...
  settings_hc_permission_body: 'Necesario para registrar actividad.',
  ...
  intro_hc_body: 'Lectura de tus pasos.',
  ...
  about_detection_body:
    'Usamos Health Connect y GPS. Todo se procesa en tu dispositivo. Ajustes → Detección.',
