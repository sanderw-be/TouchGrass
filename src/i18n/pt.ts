export default {
  ...
  // Home screen
  goal_reached: 'Boa! Já apanhaste a tua dose de ar livre hoje.',
  outside_time_awaits: '{{amount}} of outside time awaits today.',
  remaining_for_goal: '{{amount}} more to hit your daily goal.',
  this_week: 'This week',
  today: 'today',
  no_sessions_title: 'Ainda não registaste tempo ao ar livre hoje.',
  no_sessions_sub: 'Apetece-te um pouco de ar fresco? Adiciona aqui!',
  todays_sessions: 'Momentos ao ar livre de hoje',
  ...
  ring_timer_info: 'Toca no anel para iniciar manualmente o teu tempo lá fora.',
  ...
  // Session sources
  source_health_connect: 'Outras apps',
  source_gps: 'GPS',
  ...
  session_swipe_hint: 'Esquerda para fora, direita para dentro.',
  ...
  events_none_recorded: 'Ainda não há momentos ao ar livre.',
  ...
  // Settings screen
  settings_section_detection: 'Acompanhamento automático',
  ...
  settings_hc_permission_missing: 'Acesso necessário — toca para configurar',
  ...
  settings_gps_desc: 'Reconhecer momentos ao ar livre por localização',
  settings_gps_permission: 'Permission needed',
  settings_gps_permission_missing: 'Acesso necessário — toca para configurar',
  ...
  location_edit_radius: 'Reconhecimento de localização',
  ...
  settings_reminders_sublabel: 'Pequenos toques no momento certo — aprende o teu ritmo. Sem recolha de dados.',
  ...
  settings_notification_permission_missing: 'Acesso necessário — toca para configurar',
  ...
  settings_privacy_sublabel: 'Os teus dados nunca saem do teu telemóvel',
  ...
  intro_welcome_body: 'A tua ajuda para pousar o telemóvel e sair mais vezes.',
  ...
  intro_hc_why_title: 'Porque pedimos este acesso?',
  intro_hc_why_body:
  ...
  intro_location_why_title: 'Porque pedimos este acesso?',
  ...
  intro_notifications_why_title: 'Porque pedimos este acesso?',
  ...
  intro_calendar_why_title: 'Porque pedimos este acesso?',
  ...
  intro_calendar_data_scope: 'Lemos apenas horas — sem detalhes nem pessoas. Tudo fica privado no teu dispositivo.',
  ...
  notif_title_4: '👟 Calçar e sair?',
  notif_title_5: '🌳 The outdoors is calling',

  // Notification bodies
  notif_body_none: 'Ainda não saíste hoje? Uma volta curta também conta!',
  ...
  notif_reason_urgent: 'ainda não conseguiste sair hoje.',
