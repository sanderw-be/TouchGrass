...
const nl: TranslationType = {
  ...
  settings_activity_recognition: 'Bewegingsdetectie',
  settings_activity_recognition_desc:
    'Bespaar batterij door beweging te volgen in plaats van locatie',
  settings_activity_recognition_permission_missing: 'Machtigingen ontbreken — tik om te herstellen',
  ...
  intro_ar_why_title: 'Waarom is dit nodig?',
  intro_ar_why_body:
    'Bewegingsdetectie maakt de app alleen wakker als je begint of stopt met bewegen (lopen, hardlopen, rijden).',
  intro_ar_button: 'Batterijbesparing inschakelen',
  intro_ar_button_granted: 'Ingeschakeld ✓',
  ...
  intro_ready_checklist_item_hc: 'Verbind Health Connect.',
  intro_ready_checklist_item_ar: 'Schakel bewegingsdetectie in.',
