export default {
  ...
  intro_notifications_why_body: 'Slimme herinneringen leren je patronen over tijd en sturen alleen meldingen op nuttige momenten. Je kunt ook geplande herinneringen aanmaken voor specifieke tijden en dagen. Je kunt ze altijd uitschakelen.',
  ...
  intro_ready_tip_body: 'Je kunt geplande herinneringen instellen in Instellingen → Herinneringen. Maak wekelijkse schema\'s voor specifieke tijden en dagen om een consistente buiten routine op te bouwen.',
