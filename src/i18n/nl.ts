export default {
  ...
  settings_health_connect_desc: 'Stappen bijhouden',
  ...
  settings_hc_permission_body: 'Nodig om je buitenactiviteit te synchroniseren van je apparaat.',
  ...
  intro_hc_body: 'TouchGrass detecteert beweging.',
  intro_hc_why_title: 'Waarom dit nodig is?',
  intro_hc_why_body: 'Zodat we wandelen of fietsen kunnen meerekenen als buitenactiviteiten.',
  ...
  about_detection_body:
    'Geen cloud-tracking. We gebruiken Health Connect of geofencing via GPS. Beheer dit in Instellingen → Detectie.',
