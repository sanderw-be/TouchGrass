export default {
  ...
  settings_test_notification: 'Test notificatie',
  settings_test_notification_sublabel: 'Stuur een test-herinnering om actieknoppen te proberen',
  settings_test_send: 'Verstuur',
  settings_test_notification_success_title: '🔔',
  settings_test_notification_success_body: 'Test notificatie verzonden! Het zou over een moment moeten verschijnen. Probeer op de actieknoppen te tikken om het afsluitgedrag te testen.',
  settings_test_notification_error: 'Kan test notificatie niet verzenden. Zorg ervoor dat notificaties zijn ingeschakeld.',
