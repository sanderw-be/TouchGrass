export default {
  ...
  no_sessions_sub: 'Geh nach draußen oder trage es manuell ein.',
  ...
  settings_hc_permission_body: 'Wird benötigt, um Außenaktivitäten zu erkennen. Viele Schritte an einem Ort weisen meist auf einen Spaziergang draußen hin; Aktivitäten wie Laufen oder Radfahren gelten ebenfalls als Außenzeit. Mit GPS kann auch der Heimtrainer ausgeschlossen werden.',
  ...
  settings_reminders_sublabel: 'Sanfte Erinnerungen, nach draußen zu gehen.',
  ...
  manual_timer_ready: 'Starten und rausgehen',
  ...
  intro_hc_body: 'TouchGrass nutzt Health Connect, um Außenaktivitäten anhand von Schritten und Trainingssessions privat zu erkennen.',
  intro_hc_why_title: 'Warum das?',
  intro_hc_why_body: 'Viele Schritte an einem Ort bedeuten meist, dass du draußen unterwegs warst. Aktivitäten wie Laufen oder Radfahren werden ebenfalls als Außenzeit gewertet. Mit GPS aktiviert können Heimtrainersessions herausgefiltert werden.',
  ...
  intro_ready_body: 'Zeit, nach draußen zu gehen.',
  ...
  about_detection_body: 'Tracking über Health Connect (Schritte & Aktivitäten) oder GPS (Geofencing). Keine Cloud.',
  ...
  about_manual_title: 'Manuell erfassen',
