...
const de: TranslationType = {
  ...
  settings_gps_permission_missing: 'Berechtigung fehlt — zum Beheben tippen',
  settings_activity_recognition: 'Bewegungserkennung',
  settings_activity_recognition_desc: 'Akku sparen durch Bewegungserkennung statt Standort',
  settings_activity_recognition_permission_missing: 'Berechtigung fehlt — zum Beheben tippen',
  ...
  intro_ar_why_title: 'Warum brauchen wir das?',
  intro_ar_why_body:
    'Die Bewegungserkennung weckt die App nur auf, wenn du dich bewegst oder stehen bleinst (Gehen, Laufen, Fahren).',
  intro_ar_button: 'Akku-Schoner aktivieren',
  intro_ar_button_granted: 'Aktiviert ✓',
  ...
  intro_ready_checklist_item_hc: 'Health Connect verbinden.',
  intro_ready_checklist_item_ar: 'Bewegungserkennung aktivieren.',
