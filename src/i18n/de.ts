export default {
  ...
  settings_hc_permission_body: 'Wird benötigt, um Aktivitäten abzugleichen.',
  ...
  intro_hc_body: 'Für die Bewegungserkennung.',
  ...
  about_detection_body: 'Tracking über Health Connect oder GPS (Geofencing). Keine Cloud.',
