...
function getWidgetData(): {
  ...
  const timerStartEpoch = timerRunning ? parseInt(marker, 10) || undefined : undefined;
  return { current, target, timerRunning, timerStartEpoch };
}
    ...
    case 'WIDGET_RESIZED': {
      ...
      renderWidget(
        <ProgressWidget
          ...
          timerStartEpoch={data.timerStartEpoch}
        />
      );
      break;
    }
