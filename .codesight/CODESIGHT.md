...
> 0 routes | 0 models | 35 components | 59 lib files | 2 env vars | 1 middleware | 0% test coverage
> **Token savings:** this file is ~6,100 tokens. Without it, AI exploration would cost ~36,300 tokens. **Saves ~30,200 tokens per conversation.**
> **Last scanned:** 2026-04-30 06:01 — re-run after significant changes
