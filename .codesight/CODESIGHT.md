...
> 0 routes | 0 models | 38 components | 30 lib files | 2 env vars | 1 middleware | 0% test coverage
> **Token savings:** this file is ~4,500 tokens. Without it, AI exploration would cost ~29,800 tokens. **Saves ~25,300 tokens per conversation.**
> **Last scanned:** 2026-04-16 20:09 — re-run after significant changes
