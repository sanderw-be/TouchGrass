...
- `src\detection\GeofenceManager.ts` — isAtKnownIndoorLocation, isAtAnyKnownLocation, wasDefinitelyAtKnownIndoorLocationSync, shouldTriggerBurst, computeMinActiveRadius, clampRadiusMeters, …
